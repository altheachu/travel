...
//    @EventLog(logTime = LogTime.AFTER_METHOD, type = EventlogConstant.prePublishMsg)
    @Override
    public void modifyOrderStatus(Map<String, Object> paramMap) throws Exception {
        try {
            rabbitTemplate.convertAndSend(RabbitMqConstant.RABBITMQ_PRODUCT_TO_ORDER_DIRECT_EXCHANGE, RabbitMqConstant.RABBITMQ_PRODUCT_TO_ORDER_DIRECT_ROUTING, paramMap);
        } catch (Exception e){
