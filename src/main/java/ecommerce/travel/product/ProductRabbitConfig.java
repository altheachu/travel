...
public class ProductRabbitConfig {
    ...
    public Queue rabbitmqProductDirectQueue(){
         ...
         * */
        return new Queue(RabbitMQConfig.RABBITMQ_PRODUCT_TOPIC, true, false, false);
    }

    @Bean
    public DirectExchange rabbitmqProductDirectExchange() {
        //Direct交换机
        return new DirectExchange(RabbitMQConfig.RABBITMQ_PRODUCT_DIRECT_EXCHANGE, true, false);
    }
    ...
    public Binding bindProductDirect() {
        ...
        return BindingBuilder
                ...
                //并设置匹配键
                .with(RabbitMQConfig.RABBITMQ_PRODUCT_DIRECT_ROUTING);
    }
}
